...
import 'package:r6_moovie_app/domain/usecase/series/save_series_use_case.dart';
...
import '../data/network/source/remote/movies/movie_data_source.dart';
import '../data/network/source/remote/movies/movie_data_source_impl.dart';
import '../data/network/source/remote/series/series_data_source.dart';
import '../data/network/source/remote/series/series_data_source_impl.dart';
import '../data/repository/movie_repository_impl.dart';
import '../data/repository/series_repository_impl.dart';
import '../data/service/movies/movie_service_api.dart';
import '../data/service/series/series_service_api.dart';
...
void setupSeriesDependencies() {
  ...
  getIt.registerSingleton<SaveSeriesUseCase>(
      SaveSeriesUseCase(getIt<SeriesRepository>()));

  getIt.registerFactory<SeriesBloc>(
      () => SeriesBloc(getIt<GetPopularSeriesUseCase>(),
      getIt<SaveSeriesUseCase>()));
}
